! function(n) {
	...
	function t() {
		for (var n = 0, e = 0; e < 7; e++)
			for (var r = e; r < 7; r++) {
				var t = y(r);
				null !== t ? O(t, n) : k(r, n), P("desk", r, n), r === e && b(n), n++
			}
	}

	function o() {
		for (var n = 0; n < 7; n++) h.desk[n].cards = [];
		for (var e = 0; e < 4; e++) h.finish[e].cards = [];
		h.deal.pile.cards = [], h.deal.deal.cards = [], h.cards.sort(function() {
			...
			for (var n = 0, e = h.cards.length; n < e; n++) {
				var r = h.cards[n],
					o = r.facingUp,
					a = r.el;
				h.deal.pile.cards.push(n), a.onmousedown = J(n), a.onmouseup = L, a.onclick = X(n), o && A(n), p.appendChild(a)
			}
			t()
		})
	}
	...
	function a() {
		h.deal.pile.cards = h.deal.deal.cards, h.deal.deal.cards = [];
		var n = !0,
			e = !1,
			r = void 0;
		try {
	...
	function c() {
		...
		for (var r = 0; r < 4; r++)
			for (var t = 1; t <= 13; t++) {
				...
				i.classList.add("card", "card--" + h.types[r] + "-" + t, "card--back"), h.cards.push({
					el: i,
					type: h.types[r],
					number: t,
					facingUp: !1
		...
		for (var c = 0; c < 4; c++) {
			...
			d.classList.add("aces", "aces--" + c), h.finish.push({
				el: d,
				cards: []
			}), f.appendChild(d)
		}
		for (var l = 0; l < 7; l++) {
			...
			u.classList.add("seven", "seven--" + l), h.desk.push({
				el: u,
				cards: []
			}), x.appendChild(u)
		}
		p.onclick = a, g.onclick = o, window.onmousemove = V, window.onmouseup = L, o()
	}
	var d = r(0),
		s = function(n) {
	...
	var l = document.getElementById("js-solitaire"),
		...
		b = function(n) {
			h.cards[n].facingUp = !0, requestAnimationFrame(function() {
				h.cards[n].el.classList.add("card--front"), h.cards[n].el.classList.remove("card--back")
			})
		},
		A = function(n) {
			h.cards[n].facingUp = !1, h.cards[n].el.classList.remove("card--front"), h.cards[n].el.classList.add("card--back")
		},
		z = function(n) {
			var e = y(n);
			null !== e && b(e)
				...
				if (!h.moving.capture)
					if (L(), o) {
						...
						var p = l[0],
							...
							g = f.pile,
							A = f.card;
						U(v, g, A), "desk" === i && z(c), x.appendChild(t), R()
					} else {
						var O = w(n),
							k = O.location,
							y = O.pile;
						if ("deal" === k && "pile" === y)
							for (var Z = h.deal.pile.cards.length - 1, E = Math.max(-1, Z - 3), q = Z; q > E; q--) {
								var P = h.deal.pile.cards[q],
									X = m(P),
									V = X.el;
								b(P), U("deal", "deal", P), u.appendChild(V)
							}
					}
			}
		},
		V = function(n) {
			if (h.moving.capture) {
				var e = h.moving.element,
					...
					t = r.x,
					o = r.y;
				e.style.left = t - h.moving.offset.x + "px", e.style.top = o - h.moving.offset.y + "px"
			}
		},
		W = function(n) {
			var e = h.moving.element,
				...
				c = a.top,
				d = a.left;
			e.classList.add("card--moving"), h.moving.offset = {
				x: t - d,
				y: o - c
			}, e.style.left = t - h.moving.offset.x + "px", e.style.top = o - h.moving.offset.y - 5 + "px"
		},
		Y = void 0,
		J = function(n) {
			return function(e) {
				...
				if (r.facingUp) {
					var o = w(n),
						a = o.location,
						i = o.pile;
					if ("deal" === a && "deal" === i && t !== M("deal", "deal").el) return !1;
					Y = setTimeout(function() {
						h.moving.element = e.target, h.moving.capture = !0, h.moving.index = n, h.moving.card = m(n), h.moving.origin = w(n), W(e);
						var r = I(n);
						...
						var t = !0,
							...
							a = void 0;
						try {
							for (var i, c = r[Symbol.iterator](); !(t = (i = c.next()).done); t = !0) i.value.el.classList.add("finish-dest")
						} catch (n) {
							o = !0, a = n
						} finally {
							try {
			...
			try {
				for (var a, i = h.moving.destinations[Symbol.iterator](); !(r = (a = i.next()).done); r = !0) {
					var c = a.value,
						...
						p = d.left,
						u = d.top;
					if (c.el.classList.remove("finish-dest"), n > p && n < p + s && e > u && e < u + l) {
						var f = c.target,
							x = f.dest,
							v = f.pile,
							g = f.card;
						U(x, v, g), c.el.appendChild(h.moving.element), R();
		...
		j = void 0,
		L = function(n) {
			clearTimeout(Y), clearTimeout(j), h.moving.capture && (j = setTimeout(function() {
				var e = i(n),
					r = e.x,
					t = e.y;
				requestAnimationFrame(function() {
					T(r, t), h.moving.element.classList.remove("card--moving"), h.moving.element.style.left = "", h.moving.element.style.top = "", h.moving.element = null, h.moving.capture = !1
				})
			}, 100))
		},
		I = function(n) {
		...
		R = function() {
			for (var n = 3; n >= 0; n--) {
				if (h.finish[n].cards.length < 13) return
			}
	...
	var G = function(n, e, r, t) {
		function o(n) {
			n.preventDefault(), clearInterval(m);
			for (var e = 0; e < 4; e++) clearInterval(v[e]);
			i.parentNode.removeChild(i), document.removeEventListener("click", o)
		}
		var a = document.createElement("img");
		a.src = s.default;
		var i = document.createElement("canvas");
		i.style.position = "absolute", i.width = n, i.height = e, l.appendChild(i);
		for (var c = i.getContext("2d"), d = 52, p = [], u = function(n, e, r, t) {
				...
				var c = n % 4 * 71,
					d = 96 * Math.floor(n / 4);
				u(e, r, c, d), this.update = function() {
					if (e += t, r += o, e < -71 || e > i.width + 71) {
						var n = p.indexOf(a);
						return p.splice(n, 1), !1
					}
					return r > i.height - 96 && (r = i.height - 96, o = .85 * -o), o += .98, u(Math.floor(e), Math.floor(r), c, d), !0
				}
			}, x = function(n, e) {
				if (!(d < 1)) {
					d--;
	...
	n.exports = function(n) {
		...
		return e.toString = function() {
			...
			for (o = 0; o < n.length; o++) {
				var i = n[o];
				"number" == typeof i[0] && t[i[0]] || (r && !i[2] ? i[2] = r : r && (i[2] = "(" + i[2] + ") and (" + r + ")"), e.push(i))
			}
		}, e
	}
}, function(n, e, r) {
	function t(n, e) {
		for (var r = 0; r < n.length; r++) {
			...
			if (o) {
				...
				for (; a < t.parts.length; a++) o.parts.push(l(t.parts[a], e))
			} else {
				for (var i = [], a = 0; a < t.parts.length; a++) i.push(l(t.parts[a], e));
				x[t.id] = {
					id: t.id,
					refs: 1,
					parts: i
	...
	function a(n, e) {
		...
		var t = b[b.length - 1];
		if ("top" === n.insertAt) t ? t.nextSibling ? r.insertBefore(e, t.nextSibling) : r.appendChild(e) : r.insertBefore(e, r.firstChild), b.push(e);
		else {
	...
	function l(n, e) {
		...
		if (e.singleton) {
			var s = m++;
			r = h || (h = c(e)), t = p.bind(null, r, s, !1), o = p.bind(null, r, s, !0)
		} else n.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (r = d(e), t = f.bind(null, r, e), o = function() {
			i(r), r.href && URL.revokeObjectURL(r.href)
		}) : (r = c(e), t = u.bind(null, r), o = function() {
			i(r)
		});
		return t(n),
			function(e) {
	...
	function p(n, e, r, t) {
		var o = r ? "" : t.css;
		if (n.styleSheet) n.styleSheet.cssText = z(e, o);
		else {
	...
	function u(n, e) {
		var r = e.css,
			t = e.media;
		if (t && n.setAttribute("media", t), n.styleSheet) n.styleSheet.cssText = r;
		else {
	...
	function f(n, e, r) {
		...
		(e.convertToAbsoluteUrls || a) && (t = A(t)), o && (t += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(o)))) + " */");
		var i = new Blob([t], {
				type: "text/css"
			}),
			c = n.href;
	...
	var x = {},
		...
		g = function(n) {
			var e = {};
			return function(r) {
				return void 0 === e[r] && (e[r] = n.call(this, r)), e[r]
			}
		}(function(n) {
	...
	var z = function() {
		var n = [];
		return function(e, r) {
			return n[e] = r, n.filter(Boolean).join("\n")
		}
	}()
}, function(n, e) {
	n.exports = function(n) {
		...
		return n.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(n, e) {
			...
			var a;
			return a = 0 === o.indexOf("//") ? o : 0 === o.indexOf("/") ? r + o : t + o.replace(/^\.\//, ""), "url(" + JSON.stringify(a) + ")"
		})
	}
}]);