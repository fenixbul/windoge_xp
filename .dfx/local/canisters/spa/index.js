...
import { idlFactory } from './spa.did.js';
export { idlFactory } from './spa.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SPA_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./spa.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the spa canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./spa.did.js")._SERVICE>}
 */
export const spa = createActor(canisterId);
